  ...
  return (
    <View style={styles.container}>
      <View style={styles.topContainer}>
        <Image style={styles.imageTop} source={require('../../../assets/illustrations/secure-login.png')} alt='Secure Login' />
      </View>
      ...
      <View style={styles.formContainer}>
        <KeyboardAvoidingView
          ...
          style={{ gap: 10 }}
        >
          <InterText variant={'bold'} style={styles.title}>Daftar</InterText>
          ...
          <MainButton onPress={onPressSignup}>
            <InterText variant={'bold'} style={styles.textSignup}>Signup</InterText>
          </MainButton>
